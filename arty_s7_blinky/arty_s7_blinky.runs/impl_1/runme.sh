...
HD_PWD='C:/Code/rtl-projs/arty_s7_blinky/arty_s7_blinky.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinky4.tcl -notrace
