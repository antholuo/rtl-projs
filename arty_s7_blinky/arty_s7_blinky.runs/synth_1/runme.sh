...
HD_PWD='C:/Code/rtl-projs/arty_s7_blinky/arty_s7_blinky.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blinky4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinky4.tcl
